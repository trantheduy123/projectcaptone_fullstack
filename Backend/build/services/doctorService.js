...
var checkRequiredFields = function checkRequiredFields(inputData) {
  var arrFields = ["doctorId", "contentHTML", "contentMarkdown", "action", "selectedPrice", "selectedPayment", "selectedProvince", "nameClinic", "addressClinic", "specialtyId"];
  var isValid = true;
  var element = "";
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            resolve({
              errCode: 1,
              errMessage: "Missing paremeter ".concat(checkObj.element),
              inputData: inputData
            });
            _context3.next = 38;
            break;
    ...
    var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(resolve, reject) {
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          ...
          case 5:
            _context11.next = 7;
            return _emailService["default"].sendEmailtoPatient(data);
          case 7:
            resolve({
              errCode: 0,
              errMessage: "ok"
