...
var handeleCreateNewUser = /*#__PURE__*/function () {
  ...
  return function handeleCreateNewUser(_x5, _x6) {
...
var handleSignin = /*#__PURE__*/function () {
  ...
  return function handleSignin(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var handeleEditUser = /*#__PURE__*/function () {
  ...
  return function handeleEditUser(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var handeleDeleteUser = /*#__PURE__*/function () {
  ...
  return function handeleDeleteUser(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
var fbLogin = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res, next) {
    var code, redirectUri, params, response, data, userData, existingUser, _accessToken, newUser, savedUser, accessToken;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          code = req.query.code;
          redirectUri = "".concat(process.env.URL_REACT, "/auth/facebook");
          ...
          _context7.next = 10;
          return _axios["default"].post("https://graph.facebook.com/v18.0/oauth/access_token", params, {
            headers: {
        ...
        case 10:
          ...
          data = response.data; // Get user data from Facebook API
          _context7.next = 14;
        ...
        case 17:
          ...
          _context7.next = 21;
          return signAccessToken(existingUser);
        case 21:
          _accessToken = _context7.sent;
        ...
        case 26:
          ...
          _context7.next = 29;
          return signAccessToken(savedUser);
        case 29:
  ...
  return function fbLogin(_x13, _x14, _x15) {
    return _ref7.apply(this, arguments);
  };
}();
var generateRandomPassword = function generateRandomPassword(length) {
...
var signAccessToken = function signAccessToken(user) {
  return new Promise(function (resolve, reject) {
    ...
    _jsonwebtoken["default"].sign(payload, process.env.SECRET, {
      expiresIn: "24h"
    }, function (err, token) {
      if (err) {
...
var getUserData = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(accessToken) {
    var response;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 11:
          ...
          throw new Error("Error getting user data: ".concat(_context8.t0.message));
        case 14:
        case "end":
  ...
  return function getUserData(_x16) {
    return _ref8.apply(this, arguments);
  };
}();
var forgotPassword = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
    var email, response, resetToken, html;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 4:
          _context9.next = 6;
          return _userService["default"].forgotPasswordService(email);
        case 6:
        ...
        case 15:
          ...
          return _context9.abrupt("return", res.status(500).json({
            err: -1,
            msg: "Fail at auth controller: " + _context9.t0
          }));
        case 18:
        case "end":
  ...
  return function forgotPassword(_x17, _x18) {
    return _ref9.apply(this, arguments);
  };
}();
var resetPassword = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var _req$body, password, token, message;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _req$body = req.body, password = _req$body.password, token = _req$body.token;
          _context10.next = 3;
          return _userService["default"].resetPasswordService(password, token);
        case 3:
...
var getAllCode = /*#__PURE__*/function () {
  ...
  return function getAllCode(_x21, _x22) {
